...
C:/ti/tirtos_cc13xx_cc26xx_2_16_00_08/products/bios_6_45_01_29/packages/iar/targets/arm/ITarget.xs:
package.mak: C:/ti/tirtos_cc13xx_cc26xx_2_16_00_08/products/bios_6_45_01_29/packages/iar/targets/arm/ITarget.xs
C:/ti/tirtos_cc13xx_cc26xx_2_16_00_08/products/bios_6_45_01_29/packages/iar/targets/arm/package.xs:
package.mak: C:/ti/tirtos_cc13xx_cc26xx_2_16_00_08/products/bios_6_45_01_29/packages/iar/targets/arm/package.xs
...
iar.targets.arm.packageBase ?= C:/ti/tirtos_cc13xx_cc26xx_2_16_00_08/products/bios_6_45_01_29/packages/iar/targets/arm/
...
.dlls,rm3 .dlls: SimpleUART.prm3

-include package/cfg/SimpleUART_prm3.mak
-include package/cfg/SimpleUART_prm3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/SimpleUART_prm3.dep
endif
SimpleUART.prm3: package/cfg/SimpleUART_prm3.xdl
	@


ifeq (,$(wildcard .libraries,rm3))
SimpleUART.prm3 package/cfg/SimpleUART_prm3.c: .libraries,rm3
endif

package/cfg/SimpleUART_prm3.c package/cfg/SimpleUART_prm3.h package/cfg/SimpleUART_prm3.xdl: override _PROG_NAME := SimpleUART.xrm3
package/cfg/SimpleUART_prm3.c: package/cfg/SimpleUART_prm3.cfg
package/cfg/SimpleUART_prm3.xdc.inc: package/cfg/SimpleUART_prm3.xdl
package/cfg/SimpleUART_prm3.xdl package/cfg/SimpleUART_prm3.c: .interfaces

clean:: clean,rm3
	-$(RM) package/cfg/SimpleUART_prm3.cfg
	-$(RM) package/cfg/SimpleUART_prm3.dep
	-$(RM) package/cfg/SimpleUART_prm3.c
	-$(RM) package/cfg/SimpleUART_prm3.xdc.inc

clean,rm3::
	-$(RM) SimpleUART.prm3
.executables,rm3 .executables: SimpleUART.xrm3

SimpleUART.xrm3: |SimpleUART.prm3

-include package/cfg/SimpleUART.xrm3.mak
SimpleUART.xrm3: package/cfg/SimpleUART_prm3.orm3 
	$(RM) $@
	@$(MSG) lnkrm3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	LC_ALL=C $(iar.targets.arm.M3.rootDir)/bin/ilinkarm -o C:/Users/johnny/Desktop/UartOverAir/Debug/Exe/SimpleUART.out --config C:/Users/johnny/Desktop/UartOverAir/SimpleUART_CC1310DK_7XD.icf -f C:/Users/johnny/Desktop/UartOverAir/configPkg/linker.cmd c:/ti/tirtos_cc13xx_cc26xx_2_16_00_08/products/cc13xxware_2_03_01_16780/driverlib/bin/iar/driverlib.lib --silent --cpu=Cortex-M3 --entry=__iar_program_start --redirect _Printf=_PrintfSmall --redirect _Scanf=_ScanfSmall --semihosting --entry __iar_program_start --vfe --silent -o $@ package/cfg/SimpleUART_prm3.orm3 -f package/cfg/SimpleUART_prm3.xdl  --semihosting=iar_breakpoint  --cpu=Cortex-M3 --map $(XDCCFGDIR)/$@.map  --redirect _Printf=_PrintfSmall --redirect _Scanf=_ScanfSmall 
	

SimpleUART.test test,rm3 test: SimpleUART.xrm3.test

SimpleUART.xrm3.test:: SimpleUART.xrm3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 SimpleUART.xrm3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.SimpleUART.xrm3, ) 
endif

clean,rm3::
	-$(RM) $(wildcard .tmp,SimpleUART.xrm3,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
SimpleUART_prm3.orm3,copy : package/cfg/SimpleUART_prm3.orm3
SimpleUART_prm3.srm3,copy : package/cfg/SimpleUART_prm3.srm3
