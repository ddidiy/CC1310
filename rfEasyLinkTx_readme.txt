...
---------------------
Board_LED2               Indicates that a Packet has been transmitted
Board_LED1               Indicates an abort which is expected after
                         transmitting 10 packets
Board_LED1 & Board_LED2  Indicates an error
...
Example Usage
-------------
Run the example. Board_LED2 will toggle every 100 ms indicating a packet has
been transmitted. This will happen 10 times. The 11th transmission will then be
aborted, toggling LED1. This cycle will continue.
...
LED1 will toggle when a TX abort happens. LED1 and LED2 inidicates an error
(not expected to happen). The TX/abort cycle will repeat indefinitely.
